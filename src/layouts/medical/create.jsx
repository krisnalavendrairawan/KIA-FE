    ...
    const onSubmit = (data) => {
        ...
        const postData = async () => {
            try {
                ...
                Swal.fire({
                    title: 'Berhasil!',
                    text: 'Data riwayat penyakit anak berhasil ditambahkan!',
                    icon: 'success',
                    confirmButtonText: 'OK',
                });
                    ...
                    <Grid item xs={6}>
                        ...
                        <Box sx={{ width: 500, maxWidth: '100%', marginTop: 2 }}>
                            <Controller
                                ...
                                control={control}
                                rules={{
                                    required: 'Jenis penyalahgunaan harus diisi'
                                }}
                                render={({ field }) => <TextField fullWidth {...field}
                                    label="Jenis Penyakit"
                                    variant="filled"
                                    error={Boolean(errors.jenis_penyakit)}
                                    helperText={errors.jenis_penyakit && errors.jenis_penyakit.message}
                                />}
                            />
                        </Box>
                        <Box sx={{ width: 500, maxWidth: '100%', marginTop: 2 }}>
                            <Controller
                                ...
                                control={control}
                                rules={{
                                    required: 'Tempat rujukan harus diisi'
                                }}
                                render={({ field }) => <TextField fullWidth {...field}
                                    label="Tempat Rujukan"
                                    variant="filled"
                                    error={Boolean(errors.rujukan)}
                                    helperText={errors.rujukan && errors.rujukan.message}
                                    />}
                            />
                        </Box>
                        <Box sx={{ width: 500, maxWidth: '100%', marginTop: 2 }}>
                            <Controller
                                ...
                                control={control}
                                rules={{
                                    required: 'Saran dokter harus diisi'
                                }}
